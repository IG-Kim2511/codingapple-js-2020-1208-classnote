...
Symbol 자료형 만드는 법 
*/
var 심볼 = Symbol('주석comment 아무거나 적기');
...
이렇게 쓰시면 Object자료형에 Symbol을 저장가능합니다.
*/

var person36 = { name : 'Kim' };

person36.weight36 = 100;    //일반data... object에 추가

var weight36 = Symbol('내 진짜 몸무게');    //Symbol... object에 추가
person36[weight36] = 200;       //Symbol... object에 추가

console.log(person36);


// 4-4) 심볼을 오브젝트 만들 때 직접 입력할 수도 있습니다. 

var height36 = Symbol('내 키임');

var person36_2 = { name : 'Kim', [height36] : 160 };    //4-4)

console.log(person36_2)


/* 6) 같은 설명을 가졌다고 해서 같은 Symbol이 아닙니다. 

예제에서 a와 b 심볼은 설명이 같음에도 불구하고, 두개를 같다고 비교해보면 false가 남습니다. 
...
/* 8) Symbol.for()....전역심볼 global Symbol
Symbol() 대신에 Symbol.for() 로 만드시면 됩니다.  
예제를 출력해보면 true라는 값이 남습니다. 
*/
...
우리는 개발자이자 학자가 아니므로, 이런게 있다~ 까지만 알고 끝내기
*/
var array = [2,3,4];
...
-4)
console에 출력해보면, object와 달리 화살표로 나타내줍니다. 
...
-6)
Map 자료형은 key, value값에 모든 자료를 집어넣을 수 있습니다. 

key값란에...자료의 이름으로 array도 되고 object도 됩니다
*/

var person37 = new Map();   //2)
person37.set('name', 'Kim');   //2)
person37.set([1,2,3], 20);    //2-6)
