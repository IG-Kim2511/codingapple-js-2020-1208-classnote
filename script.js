...
// 🦄c14 Spread Operator2: array를 파라미터로 넣기, apply, call 함수

/* 
🍉2) 어레이라는 자료 안에 있는 모든 숫자 10,20,30을 더하기() 함수의 파라미터로 집어넣으려면 어떻게 해야합니까.
...
차이점이 하나 있는데, 내가 person.인사()에 파라미터를 넣어서 실행하고 싶은 경우에는 
